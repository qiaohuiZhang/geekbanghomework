package week2.homework2.gateway.inbound;
...
import week2.homework2.gateway.outbound.HttpOutboundHandler;
...
public class HttpHandler extends ChannelInboundHandlerAdapter {
    ...
    public HttpHandler(String qryUrl) {
        this.qryUrl = qryUrl;
        this.handler = new HttpOutboundHandler(qryUrl);
    }
