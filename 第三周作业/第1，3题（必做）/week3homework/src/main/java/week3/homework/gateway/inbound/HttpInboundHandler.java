...
import week3.homework.gateway.filter.RequestFilterImpl;
import week3.homework.gateway.outbound.HttpOutboundHandler;
...
public class HttpInboundHandler extends ChannelInboundHandlerAdapter {
    ...
    private RequestFilter filter = new RequestFilterImpl();

    public HttpInboundHandler(List<String> proxyServices) {
        this.proxyServices = proxyServices;
        this.outboundHandler = new HttpOutboundHandler(proxyServices);
    }
